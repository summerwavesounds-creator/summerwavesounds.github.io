...
import { 
  Play, Pause, ChevronDown, Heart, Youtube, Instagram, Twitter, 
  Music2, ArrowRight, Sparkles, Globe, Users, Zap, Headphones, 
  Radio, Star, Menu, X, Volume2, TrendingUp, Coffee, Moon, Sun 
} from "lucide-react";

// REAL videos from SummerWaveSounds channel (confirmed embed IDs from channel / shared link)
const VIDEOS = [
  { id: "GnmG5FX2M2E", title: "Feel-Good City Vibes Mix", genre: "Deep House", tag: "🌆 City Nights", duration: "1 HR", mood: "City Vibes" },
  ...
  { id: "jjX6AGi6v5g", title: "Summer Music Mix 2026 – Night Vibes / Stress Relief", genre: "Chill EDM", tag: "🌙 Night", duration: "1 HR", mood: "Chill" },
...
function VideoCard({ video, featured = false }) {
  ...
  return (
    <div
      ...
      className="group relative bg-zinc-900/40 border border-zinc-800/80 hover:border-orange-500/40 rounded-2xl overflow-hidden transition-all duration-300"
    >
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Simulate audio element pulse effect
    const interval = setInterval(() => {
      if (isPlaying) {
        // Triggers re-renders to randomize soundbar heights
        setActiveGenre(prev => prev);
      }
    }, 100);
      ...
      <section id="about" className="py-24 border-t border-zinc-900 bg-zinc-950/20 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-lg text-zinc-400 leading-relaxed max-w-3xl mx-auto font-normal">
            SummerWave Sounds was founded to unite dynamic electronic soundscapes with global humanitarian work. We construct seamless, hour-long musical mixes meticulously engineered to keep you focused, energized, and inspired, whether you are coding, relaxing, or working out.
          </p>
        </div>
      </section>
      ...
      <section id="mission" className="py-24 border-t border-zinc-900 max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-8 hover:border-orange-500/20 transition-all group">
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">
              Malnutrition remains an critical obstacle to child development. Every stream on our videos helps fill localized supply chains, securing nutrient-dense provisions for soup kitchens and urgent distribution networks across disadvantaged urban sectors.
            </p>
          </div>
        </div>
      </section>
